...
export const meta = {
  ...
  lastEdited: '2019-09-11T21:16:16.000Z'
}

Use the deploy button to create a ZEIT Project from any GitHub repository, and optionally create a copy of the original repository in your Git account.
...
<a href="https://zeit.co/new/project?template=https://github.com/zeit/now-examples/tree/master/gatsby">
  <Image src="https://zeit.co/button" width={180} height={60} />
</a>
