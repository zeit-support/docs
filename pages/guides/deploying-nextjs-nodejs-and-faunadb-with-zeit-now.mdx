...
This guide walks you through creating a [Next.js](https://nextjs.org) app that receives data from a [Node.js](https://nodejs.org/en/) API powered by [FaunaDB](https://fauna.com/), and how to deploy it with ZEIT Now.
