...
export const meta = {
  ...
  published: '2019-09-18T17:00:00.000Z',
  authors: ['danieltodonnell', 'msweeneydev'],
  url: '/guides/deploying-nextjs-nodejs-and-faunadb-with-zeit-now',
  image: `${
    process.env.ASSETS
  }/guides/deploying-nextjs-nodejs-and-faunadb-with-zeit-now/card.png`,
...
This guide walks you though creating a [Next.js](https://nextjs.org) app that receives data from a [Node.js](https://nodejs.org/en/) API powered by [FaunaDB](https://fauna.com/), and how to deploy it with ZEIT Now.

By following this guide, you will create a clone of the [example app](https://nextjs-faunadb-nodejs.now-examples.now.sh/), a starting point to get you up and running with your own Next.js, Node.js, and FaunaDB app in minutes.
...
<Snippet dark text="mkdir -p faunadb-demo/pages/api && cd faunadb-demo" />
<Caption>
        ...
        <div className="container">
          ...
          {data.map(d => (
            <div className="table table-row">
              ...
              <p className="telephone">{d.data.telephone}</p>
              <div className="credit-card credit-card-number">
