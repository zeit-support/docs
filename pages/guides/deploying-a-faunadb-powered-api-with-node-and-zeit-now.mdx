...
export const meta = {
  ...
  lastEdited: '2019-08-19T04:46:52.000Z'
}
...
It's time to create the Node.js API endpoint that will be fetching our data from FaunaDB. Let’s create a folder to hold our api code. ZEIT Now with zero config convention expects it to be in an `/api` folder.
