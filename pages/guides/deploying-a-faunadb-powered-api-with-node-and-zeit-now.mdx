...
export const meta = {
  ...
  lastEdited: '2019-08-16T07:22:50.000Z'
}
...
[You can use this FQL script file](TODO).
...
This project is [available in Github](TODO) so you can clone/fork it yourself. It also includes supporting files that should speed up compilation.
...
For more information on working with faunaDB, please refer to [their documentation](https://docs.fauna.com/fauna/current/index.html).
