...
export const meta = {
  ...
  lastEdited: '2019-08-27T13:13:42.000Z'
}
...
From here, the simplest way to create a demo schema with some data is to execute a _Fauna Query Language (FQL)_ script file from [the "Shell" in the side navigation bar](https://dashboard.fauna.com/webshell/@db/zeit).
