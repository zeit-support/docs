...
export const meta = {
  title: 'Create and Deploy a FaunaDB-powered Node.js API',
  description:
    'Learn how to create a FaunaDB backed Node.js API and deploy it with ZEIT Now.',
  published: '2019-09-01T17:00:00.000Z',
  authors: ['danieltodonnell'],
  url: `/guides/create-and-deploy-a-faunadb-powered-node-js-api`,
  image: `${
    process.env.ASSETS
  }/guides/create-and-deploy-a-faunadb-powered-node-js-api/card.png`,
  editUrl: 'pages/guides/create-and-deploy-a-faunadb-powered-node-js-api.mdx',
  lastEdited: '2019-09-01T02:50:20.000Z'
}
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/create-and-deploy-a-faunadb-powered-node-js-api/fauna-register.png`}
  width={2048 / 2.5}
  height={1568 / 2.5}
  oversize
/>
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/create-and-deploy-a-faunadb-powered-node-js-api/fauna-create-zeit-db.png`}
  width={2048 / 2.5}
  height={1628 / 2.5}
  oversize
/>
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/create-and-deploy-a-faunadb-powered-node-js-api/fauna-zeit-db-home.png`}
  width={2048 / 2.5}
  height={1536 / 2.5}
  oversize
/>
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/create-and-deploy-a-faunadb-powered-node-js-api/fauna-zeit-db-shell.png`}
  width={2048 / 2.5}
  height={1536 / 2.5}
  oversize
/>
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/create-and-deploy-a-faunadb-powered-node-js-api/fauna-zeit-db-collections.png`}
  width={2048 / 2.5}
  height={1536 / 2.5}
  oversize
/>
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/create-and-deploy-a-faunadb-powered-node-js-api/fauna-zeit-db-security.png`}
  width={2048 / 2.5}
  height={1536 / 2.5}
  oversize
/>
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/create-and-deploy-a-faunadb-powered-node-js-api/json-output.png`}
  width={852 / 2}
  height={1376 / 2}
  oversize
/>
...
This project is [available in Github](https://github.com/danieltodonnell/faunadb-zeit-fql-demo).
